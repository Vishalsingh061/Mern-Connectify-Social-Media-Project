...
const PostDetails = () => {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                const res = await fetch(`https://mern-social-media-vt8f.onrender.com/post/find/${id}`)
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                const res = await fetch(`https://mern-social-media-vt8f.onrender.com/comment/${id}`, {
                    headers: {
        ...
        <div className={classes.container}>
            <div className={classes.wrapper}>
                <div className={classes.left}>
                    <img src={post?.photo && `https://mern-social-media-vt8f.onrender.com/images/${post?.photo}`} />
                </div>
