...
const Post = ({ post }) => {
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                const res = await fetch(`https://mern-social-media-vt8f.onrender.com/comment/${post._id}`, {
                    headers: {
    ...
    const deletePost = async () => {
        try {
            await fetch(`https://mern-social-media-vt8f.onrender.com/post/${post._id}`, {
                headers: {
                    "Authorization": `Bearer ${token}`
                },
                method: 'DELETE'
    ...
    const handleLikePost = async () => {
        try {
            await fetch(`https://mern-social-media-vt8f.onrender.com/post/toggleLike/${post._id}`, {
                headers: {
                    "Authorization": `Bearer ${token}`
                },
                method: "PUT"
    ...
    const handleBookmark = async () => {
        try {
            await fetch(`https://mern-social-media-vt8f.onrender.com/user/bookmark/${post._id}`, {
                headers: {
                    "Authorization": `Bearer ${token}`
                },
                method: "PUT"
    ...
    const handlePostComment = async () => {
        ...
        try {
            const res = await fetch(`https://mern-social-media-vt8f.onrender.com/comment`, {
                headers: {
        ...
        <div className={classes.container}>
            <div className={classes.wrapper}>
                ...
                <div className={classes.center}>
                    ...
                    <img className={classes.postImg} src={post?.photo ? `https://mern-social-media-vt8f.onrender.com/images/${post?.photo}` : woman} />
                </div>
